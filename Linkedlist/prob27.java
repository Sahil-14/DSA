 ...
 * of the first level of the list. Flatten the list so that all the nodes appear
 * in a single-level linked list. You need to flatten the list in way that all
 * nodes at the first level should come first, then nodes of second level, and
 * so on.
