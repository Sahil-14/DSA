 ...
 * (i) Pointer to next node in the main list (we call it ‘right’ pointer in the
 * code below)
 * (ii) Pointer to a linked list where this node is headed (we call it the
 * ‘down’ pointer in the code below).
 ...
 * input list, output list should be
...
class FlatternList {
    ...
    public static void main(String args[]) {
        FlatternList L = new FlatternList();
