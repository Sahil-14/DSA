 ...
 * that can be put
 * in one line (line width). Put line breaks in the given sequence such
 * that the
 ...
 * lines gets
 * penalized as 2(1 + 1). So we prefer 1 empty space on different lines
 * over 2 empty space on
 * one line.
 * 
 * For every range i,j(words from i to j) find the cost of putting them
 * on one line. If words
 ...
 * 
 * Then apply this formula to get places where words need to be going on
 * new line.
