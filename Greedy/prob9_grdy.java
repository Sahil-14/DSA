 ...
 * fraction is unit fraction if numerator is 1 and denominator is a positive
 ...
 * 
 * 
 * We can generate Egyptian Fractions using Greedy Algorithm. For a given number
 * of the form ‘nr/dr’ where dr > nr, first find the greatest possible unit
 * fraction, then recur for the remaining part. For example, consider 6/14, we
 * first find ceiling of 14/6, i.e., 3. So the first unit fraction becomes 1/3,
