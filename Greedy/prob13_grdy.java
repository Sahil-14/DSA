 ...
 * Now, to obtain the answer having maximum sum of difference between
 * consecutive element, arrange element in following manner:
 ...
 * Note – a(n/2)+1 This term is considered only for even n because for odd n, it
 * is added once and subtracted once and hence cancels out.
 * 
 * 
 * 
 */

public class prob13_grdy {
