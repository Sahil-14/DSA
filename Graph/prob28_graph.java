 ...
 * Determine what is the minimum time required so that all the oranges become
 * rotten. A rotten orange at index [i,j] can rot other fresh orange at indexes
 * [i-1,j], [i+1,j], [i,j-1], [i,j+1] (up, down, left and right). If it is
