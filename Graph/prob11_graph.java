 ...
 * Fibonacci heap). Dijkstra doesn’t work for Graphs with negative weights,
 * Bellman-Ford works for such graphs. Bellman-Ford is also simpler than
...
public class prob11_graph {
  ...
  void BellmanFord(prob11_graph graph, int src) {
  ...
  public static void main(String[] args) {
    ...
    prob11_graph graph = new prob11_graph(V, E);
