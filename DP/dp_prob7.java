...
// given a sequece find the longest subsequece such that all the elements in the subsequence in the sorted order
/**
 * 
 * Youtube link - https://youtu.be/CE2b_-XfVDk
 * 
 * Find a subsequence in given array in which the subsequence's elements are
 * in sorted order, lowest to highest, and in which the subsequence is as long
 * as possible
 * 
 * Solution :
...
public class dp_prob7 {
    ...
    public static void main(String arg[]) {
        dp_prob7 ob = new dp_prob7();
        // int arr[] = {23,10,22,5,33,8,9,21,50,41,60,80,99, 22,23,24,25,26,27};
        int arr[] = { 3, 4, -1, 0, 6, 2, 3 };
        int result = ob.longestSubsequenceWithActualSolution(arr);
